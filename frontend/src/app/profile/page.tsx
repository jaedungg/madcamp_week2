  ...
  return (
    <div className="w-full h-[832px] relative overflow-hidden bg-black mx-auto px-4">
      ...
      <img
        ...
        className="w-[145px] h-[145px] absolute left-[50px] top-[124px] rounded-2xl object-cover"
      />
      <div className="absolute left-[230px] top-[211px] inline-flex items-center gap-2 z-10">
        {isEditingName ? (
          <input
      ...
      <p className="w-[310px] h-[21px] absolute left-[230px] top-[247px] text-sm font-semibold text-left text-white">
    ...
    <div className="w-full h-[508px] absolute left-1/2 -translate-x-1/2 top-[416px] overflow-hidden px-4">
        <div className="w-[305px] h-9 absolute left-[60px] top-0">
        ...
        <div className="w-full overflow-x-auto mt-[57px] pl-[50px]">
          <div className="flex gap-2 min-w-fit">
            <MovieVerticalGallery movieIds={recentViewedIds} />
          </div>
        </div>
      </div>
      <p className="w-[85px] h-9 absolute left-[50px] top-[276px] text-3xl font-semibold text-left text-white">
        Tags
      </p>
      <div className="flex justify-start items-center absolute left-[50px] top-[318px] gap-2.5">
